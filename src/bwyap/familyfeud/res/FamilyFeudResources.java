...
public class FamilyFeudResources extends ResourceLoader {
	...
	public void init() {
		...
		SoundManager.getInstance().loadClip("click", SoundRegion.AU, "/bwyap/familyfeud/res/sound/us_click.wav");
		...
		SoundManager.getInstance().loadClip("click", SoundRegion.US, "/bwyap/familyfeud/res/sound/us_click.wav");
